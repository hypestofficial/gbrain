...
export class PostgresEngine implements BrainEngine {
   ...
   * same scoped read transaction (RLS scope binding + configurable per-arm
   * statement timeout, see `resolveSearchArmTimeoutMs`) as the FTS keyword
   * paths. See src/core/postgres-engine/cjk-search.ts.
   */
